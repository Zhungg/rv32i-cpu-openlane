...
//
// File: rtl/pipeline/rv32i_id_ex.sv
//
...
module rv32i_id_ex (
    ...
    input  rv32i_types_pkg::id_ex_payload_t    payload_i,

    output logic                              valid_o,
    input  logic                              ready_i,
    output rv32i_types_pkg::id_ex_payload_t    payload_o
);

    import rv32i_types_pkg::*;

    logic              valid_q;
    id_ex_payload_t     payload_q;
