...
//
// File: rtl/pipeline/rv32i_mem_wb.sv
//
...
module rv32i_mem_wb (
    ...
    input  rv32i_types_pkg::mem_wb_payload_t    payload_i,

    output logic                              valid_o,
    input  logic                              ready_i,
    output rv32i_types_pkg::mem_wb_payload_t    payload_o
);

    import rv32i_types_pkg::*;

    logic              valid_q;
    mem_wb_payload_t     payload_q;
